...
const projects = [
  {
    ...
    description: "Frontend untuk deteksi bahasa isyarat BISINDO menggunakan YOLO dan MediaPipe.",
  ...
  },
  {
    ...
    description: "Backend real-time AI BISINDO dengan WebSocket dan Python.",
  ...
  },
  {
    ...
    description: "Aplikasi prediksi cuaca dengan ML, frontend React dan backend Python.",
  ...
  },
  {
    ...
    description: "Platform agency dengan stack MERN, frontend dan backend terpisah.",
    image: "/projects/agency2.png",
    tags: ["Frontend", "Backend", "MERN", "MongoDB", "Express", "React", "Node.js"],
          ...
          {projects.map((project, key) => (
            ...
            >
              <div className="h-48 overflow-hidden relative">
                ...
                />
                <span className={
                  `absolute top-3 left-3 px-3 py-1 text-xs font-bold rounded-full shadow-md ` +
                  (project.category === "frontend" ? "bg-blue-500/80 text-white" :
                  project.category === "backend" ? "bg-green-500/80 text-white" :
                  project.category === "fullstack" ? "bg-purple-500/80 text-white" :
                  project.category === "android" ? "bg-orange-500/80 text-white" : "bg-secondary/80 text-foreground")
                }>
